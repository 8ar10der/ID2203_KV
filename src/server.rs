...
pub(crate) async fn main() {
    ...
    let op: OmniPaxosHandle<KeyValue, KVSnapshot> = OmniPaxosNode::new(node_conf, storage);
    ...
    //These channels are extracted for interacting with sequence-paxos component and BLE component
                ...
                Some(msg) => {
                    ...
                    match deserialized.operation {
                        ...
                        Operation::Write => {
                            ...
                            //append
                            if let Ok(_) = omni_paxos.append(write_entry).await {
                        ...
                        Operation::Snap => {
                            ...
                            if let Ok(_) = omni_paxos.snapshot(None, false).await {
